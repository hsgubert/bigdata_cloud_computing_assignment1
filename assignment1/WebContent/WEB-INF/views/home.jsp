		...
		<div class="container">
	    	...
	    	<div class="row">
				<div id="home_jumbotron" class="jumbotron col-xs-12">
					...
					<p>Student: <span class="link-blue" data-toggle="tooltip" data-placement="right" data-html="true" title="hs2807 - please login using my Columbia Mail and my UNI as password">Henrique</span></p>
